...
import NoToggleDemo from './NoToggleDemo.vue'
import noToggleDemoSource from './NoToggleDemo.vue?raw'
...
export const demos: DemoDefinition[] = [
  ...
  { id: 'NoToggleDemo', titleKey: 'demo.inputPassword.noToggle', component: NoToggleDemo, source: noToggleDemoSource },
]

export const apiComponents = ['InputPassword']
